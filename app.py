...
app = Flask(__name__)
app.secret_key = "dlskafjakdj"  # Replace with your own secret key
...
def confidence_interval():
    ...
    plt.errorbar(
    mean_estimate, 0,
    xerr=[[mean_estimate - ci_lower], [ci_upper - mean_estimate]],
    fmt='o', color="blue", capsize=5, label=f"{confidence_level}% Confidence Interval"
    )
